...
const BillAccToDateRangeUnpaid = (req,res) =>{
    ...
    if( startDate == null || endDate == null){
        ...
        const query = `SELECT * FROM bill WHERE bil_date BETWEEN '${startDate}' AND '${endDate}' AND payment_status = 'unpaid'`;
...
module.exports = BillAccToDateRangeUnpaid;